...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "/* You can add global styles to this file, and also import other style files */\n.itemMargin {\n  margin-left: 25px;\n  margin-top: 10px;\n}\n.field {\n  margin-right: 25px;\n}\ntd {\n  padding: 10px;\n}\ntable {\n  border-spacing: 10px;\n  border-collapse: separate;\n}", "",{"version":3,"sources":["webpack://src/styles.scss"],"names":[],"mappings":"AAAA,8EAAA;AACA;EACI,iBAAA;EACA,gBAAA;AACJ;AAEA;EACI,kBAAA;AACJ;AAEA;EACI,aAAA;AACJ;AAEA;EACI,oBAAA;EACA,yBAAA;AACJ","sourcesContent":["/* You can add global styles to this file, and also import other style files */\n.itemMargin {\n    margin-left: 25px;\n    margin-top: 10px;\n}\n\n.field {\n    margin-right: 25px;\n}\n\ntd { \n    padding: 10px;\n}\n\ntable { \n    border-spacing: 10px;\n    border-collapse: separate;\n}\n"],"sourceRoot":""}]);
// Exports
...
module.exports = __webpack_require__(/*! C:\Work\phillycc\learnrx\src\styles.scss */"+EN/");
